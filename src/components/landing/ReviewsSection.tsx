...
const REVIEWS: Review[] = [
  {
    ...
    content: "used to spend hours scrolling maps. ran my first search and had 30+ businesses without websites in minutes. landed 3 clients in month one — paid for itself straight away.",
    avatar: 'JT',
    stars: 5,
  },
  {
    name: 'Marcus L.',
    role: 'Web Designer',
    content: "my team used to do this manually — took ages. now we search, grab numbers, and message. reaching 5x more businesses and actually getting replies. massive time saver.",
    avatar: 'ML',
    stars: 5,
  },
  {
    ...
    content: "the website classification is solid — saves me calling places that already have sites. even the odd miss is worth it for the time saved. good value for the price.",
    avatar: 'DR',
    stars: 4,
  },
  {
    ...
    content: "simple tool, does exactly what it says. tracking leads from first text to payment in one place is really useful. tried the free trial and kept it — worth it.",
    avatar: 'RK',
    stars: 5,
  },
];

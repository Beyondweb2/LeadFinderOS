...
const REVIEWS: Review[] = [
  {
    ...
    content: "was spending hours scrolling maps before this. ran my first search and had a list of 30+ businesses without websites in minutes. landed 3 clients in my first month — tool paid for itself straight away.",
    avatar: 'JT',
    stars: 5,
  },
  {
    name: 'Marcus L.',
    role: 'Web Designer',
    content: "my team used to do this manually and it took ages. now we just search, grab the numbers, and send messages. we're reaching 5x more businesses than before and actually getting replies.",
    avatar: 'ML',
    stars: 5,
  },
  {
    ...
    content: "the classification isn't perfect but it's pretty solid — saves me calling places that already have sites. even the odd miss is worth it for the time saved. good value for what it does.",
    avatar: 'DR',
    stars: 4,
  },
  {
    ...
    content: "been using it a few weeks now. simple tool, does exactly what it says. being able to track leads from first text to payment in one place is really useful. worth trying out.",
    avatar: 'RK',
    stars: 5,
  },
];

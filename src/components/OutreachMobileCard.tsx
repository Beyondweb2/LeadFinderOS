...
export function OutreachMobileCard({
  ...
  return (
    <div 
      className={`py-2 px-3 border-b border-border/50 ${lead.is_potential_work ? 'bg-primary/5' : ''} ${isHighlighted ? 'ring-2 ring-primary ring-inset bg-primary/10' : ''}`}
      onClick={onLeadClick}
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-semibold text-sm">{lead.business_name}</span>
      ...
      <div className="flex items-center gap-1 mt-1.5 ml-6" onClick={(e) => e.stopPropagation()}>
        ...
        {!readOnly && (
          ...
          >
            <SelectTrigger className="w-auto h-auto p-0 border-0 bg-transparent focus:ring-0 ml-1">

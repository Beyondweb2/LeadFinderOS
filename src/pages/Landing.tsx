...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative z-10 py-12 sm:py-16 md:py-2444 px-3 sm:px-4">
      ...
      <section className="relative z-10 py4 sm:py-18 md:py-2440 px-3 sm:px-4">
        <div
      ...
      {/* Testimonials */}
      <ScrollReveal className="relative z-10 py-4 sm:py-18 md:py-240 px-4">
        {/* Subtle background */}
        <div
          className="absolute inset-0 -z-10"
          style={{

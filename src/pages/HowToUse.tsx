...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Head to your Outreach page to see all saved leads. Tap the WhatsApp, SMS or Call button to reach out directly. Use message templates to send personalised pitches in seconds. Once contacted, update the status and star interested ones to track them right there.',
    image: step3Crm,
  ...
  },
  {
    ...
    description: 'When a lead shows interest, star it to track it — then open its row in Outreach for the full detail. Set deal stages, schedule follow-ups, add notes, log revenue, and manage each lead through to payment. Everything auto-saves as you go.',

/* ════════════════════════════════════════════════════════════════════════════════════════════════
   WHICH OF THE REVIEWED QUESTIONS ACTUALLY RUN — the full measurement's selection.

   ⛔ WHY SELECTION IS NOT DELETION. The wizard's review step has always let an operator delete a
   question they did not want. For a 1..80 full measure that is the wrong tool: deleting loses the

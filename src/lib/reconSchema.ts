...
export const RECON_SCHEMA_LINES: string[] = [
  ...
  '  "strengths": [{ "category": "reviews", "label": "Google reviews widget: 5 stars, 138 reviews",',
  '                  "evidence": "homepage, below Our Recent Work (drawn by JavaScript)", "sourceUrl": "https://…" }],',
  '  "warnings": [""]',
  '}',
];
...
export const RECON_RULES_LINES: string[] = [
  ...
  '- strengths: what the old site already does WELL (separate from problems). category: logo, colours, photography, projects,',
  '  gallery, accreditations, qualifications, reviews, customer_groups, service_breadth, urgent_services, pricing, quoting, faqs,',
  '  service_areas, contact_form, conversion_routes, trust_sections, customer_questions, visual_sections, brand_cues, other.',
  '  Read the RENDERED page for them (JavaScript widgets). Never decide what happens to a strength — Paul does.',

-- Update log_usage_event to accept new analytics event types
...
DECLARE
  ...
  v_allowed_types text[] := ARRAY[
    ...
    'search_blocked', 'trial_modal_opened', 'trial_checkout_started',
    'walkthrough_opened', 'walkthrough_step_viewed', 'walkthrough_step_completed', 'walkthrough_completed',
    'search_1_completed', 'search_2_blocked'
  ];
BEGIN
